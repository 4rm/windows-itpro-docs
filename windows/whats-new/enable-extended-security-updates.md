...
> [!NOTE]
> After you purchase the ESU licenses, the MAK will appear in the [Microsoft 365 admin center](https://admin.microsoft.com). You can activate the key once the defined ESU coverage period begins, and verify that it has been activated successfully using the instructions. The first ESU update which requires the activation will be the November 2025 security update.
